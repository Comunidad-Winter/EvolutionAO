...
Public Captcha(3) As Byte

Public CountFinish As Boolean
Public CountTime As Integer

Public TopPressed As Byte

' @@ Ranking
Public Type tRanking
    Value(0 To 8) As Long
    Nombre(0 To 8) As String
End Type
...
' @ Mapa en render
Public ColourName As Byte
Public FadingTime As Integer
' @ Mapa en render

' @@ Seguimientos
Public tMaxHP As Integer
Public tMaxMAN As Integer
' @@ Seguimientos
...
Public cPJ(1 To 8) As PJs
' @@ Cuentas

' @@ Viajes
Public MAX_CIUDADES As Byte
...
Public Const iBarcaCiuda As Integer = 395
Public Const iBarcaPk As Integer = 396
Public Const iGaleraCiuda As Integer = 397
Public Const iGaleraPk As Integer = 398
Public Const iGaleonCiuda As Integer = 399
Public Const iGaleonPk As Integer = 400

Public Const CurServerIp As String = "localhost"
Public Const CurServerPort As Integer = 7690
...
Public INT_USEITEMU As Integer   'Intervalo de usar u
Public INT_USEITEMDCK As Integer    'Intervalo de usar click
