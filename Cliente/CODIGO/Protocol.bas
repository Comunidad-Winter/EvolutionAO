...
Private Enum ServerPacketID
    ...
    UpdateOnline            'Actualizar onlines en el label
    SeeInProcess            'Vemos procesos
...
Private Enum ClientPacketID
    ...
    SCaptions
    Ping                    '/PING
    Torneo                  '/TORNEO NUEVOT NUMERO (1 al 5) opciones.. en servidor
...
Public Sub InitFonts()
    ...
    'Agregamos color al cliquear al rango Administrador.
...
Public Sub HandleIncomingData()
    ...
    Select Case PacketID
        ...
        Case ServerPacketID.ShowFormViajes
            Call HandleShowFormViajes

        Case ServerPacketID.AccountLogged
            Call HandleAccountLogged

        Case ServerPacketID.UpdateSegHP
            Call HandleUpdateSegHP

        Case ServerPacketID.UpdateSegMANA
            Call HandleUpdateSegMANA

        Case ServerPacketID.UpdateSegInitial
            Call HandleUpdateSegInitial
            
        Case ServerPacketID.RecibirRanking
            Call HandleRecibirRanking
            
        Case ServerPacketID.CuentaRegresiva
            Call HandleCuentaRegresiva
            
        Case ServerPacketID.CaptchaCode
            Call HandleCaptchaCode
    ...
    With incomingData
        ...
        Select Case .ReadByte
            ...
            Case eMessages.NPCSwing
                Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_CRIATURA_FALLA_GOLPE, 255, 37, 37, True, False, True)

            Case eMessages.NPCKillUser
                Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_CRIATURA_MATADO, 255, 37, 37, True, False, True)

            Case eMessages.BlockedWithShieldUser
                Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_RECHAZO_ATAQUE_ESCUDO, 255, 37, 37, True, False, True)

            Case eMessages.BlockedWithShieldOther
                Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_USUARIO_RECHAZO_ATAQUE_ESCUDO, 255, 37, 37, True, False, True)

            Case eMessages.UserSwing
                Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_FALLADO_GOLPE, 255, 37, 37, True, False, True)
            ...
            Case eMessages.NobilityLost
                Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_PIERDE_NOBLEZA, 255, 37, 37, False, False, True)

            Case eMessages.CantUseWhileMeditating
                Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_USAR_MEDITANDO, 255, 37, 37, False, False, True)

            Case eMessages.NPCHitUser
                Select Case incomingData.ReadByte()
                    Case bCabeza
                        Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_GOLPE_CABEZA & CStr(incomingData.ReadInteger()) & "!!", 255, 37, 37, True, False, True)

                    Case bBrazoIzquierdo
                        Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_GOLPE_BRAZO_IZQ & CStr(incomingData.ReadInteger()) & "!!", 255, 37, 37, True, False, True)

                    Case bBrazoDerecho
                        Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_GOLPE_BRAZO_DER & CStr(incomingData.ReadInteger()) & "!!", 255, 37, 37, True, False, True)

                    Case bPiernaIzquierda
                        Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_GOLPE_PIERNA_IZQ & CStr(incomingData.ReadInteger()) & "!!", 255, 37, 37, True, False, True)

                    Case bPiernaDerecha
                        Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_GOLPE_PIERNA_DER & CStr(incomingData.ReadInteger()) & "!!", 255, 37, 37, True, False, True)

                    Case bTorso
                        Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_GOLPE_TORSO & CStr(incomingData.ReadInteger() & "!!"), 255, 37, 37, True, False, True)
                End Select

            Case eMessages.UserHitNPC
                Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_GOLPE_CRIATURA_1 & CStr(incomingData.ReadLong()) & MENSAJE_2, 255, 37, 37, True, False, True)

            Case eMessages.UserAttackedSwing
                Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_1 & charlist(incomingData.ReadInteger()).Nombre & MENSAJE_ATAQUE_FALLO, 255, 37, 37, True, False, True)
            ...
            Case eMessages.UserHittedByUser
                ...
                Select Case BodyPart
                    Case bCabeza
                        Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_1 & AttackerName & MENSAJE_RECIVE_IMPACTO_CABEZA & Daño & MENSAJE_2, 255, 37, 37, True, False, True)

                    Case bBrazoIzquierdo
                        Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_1 & AttackerName & MENSAJE_RECIVE_IMPACTO_BRAZO_IZQ & Daño & MENSAJE_2, 255, 37, 37, True, False, True)

                    Case bBrazoDerecho
                        Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_1 & AttackerName & MENSAJE_RECIVE_IMPACTO_BRAZO_DER & Daño & MENSAJE_2, 255, 37, 37, True, False, True)

                    Case bPiernaIzquierda
                        Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_1 & AttackerName & MENSAJE_RECIVE_IMPACTO_PIERNA_IZQ & Daño & MENSAJE_2, 255, 37, 37, True, False, True)

                    Case bPiernaDerecha
                        Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_1 & AttackerName & MENSAJE_RECIVE_IMPACTO_PIERNA_DER & Daño & MENSAJE_2, 255, 37, 37, True, False, True)

                    Case bTorso
                        Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_1 & AttackerName & MENSAJE_RECIVE_IMPACTO_TORSO & Daño & MENSAJE_2, 255, 37, 37, True, False, True)
                End Select
            ...
            Case eMessages.UserHittedUser
                ...
                Select Case BodyPart
                    Case bCabeza
                        Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_PRODUCE_IMPACTO_1 & VictimName & MENSAJE_PRODUCE_IMPACTO_CABEZA & Daño & MENSAJE_2, 255, 37, 37, True, False, True)

                    Case bBrazoIzquierdo
                        Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_PRODUCE_IMPACTO_1 & VictimName & MENSAJE_PRODUCE_IMPACTO_BRAZO_IZQ & Daño & MENSAJE_2, 255, 37, 37, True, False, True)

                    Case bBrazoDerecho
                        Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_PRODUCE_IMPACTO_1 & VictimName & MENSAJE_PRODUCE_IMPACTO_BRAZO_DER & Daño & MENSAJE_2, 255, 37, 37, True, False, True)

                    Case bPiernaIzquierda
                        Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_PRODUCE_IMPACTO_1 & VictimName & MENSAJE_PRODUCE_IMPACTO_PIERNA_IZQ & Daño & MENSAJE_2, 255, 37, 37, True, False, True)

                    Case bPiernaDerecha
                        Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_PRODUCE_IMPACTO_1 & VictimName & MENSAJE_PRODUCE_IMPACTO_PIERNA_DER & Daño & MENSAJE_2, 255, 37, 37, True, False, True)

                    Case bTorso
                        Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_PRODUCE_IMPACTO_1 & VictimName & MENSAJE_PRODUCE_IMPACTO_TORSO & Daño & MENSAJE_2, 255, 37, 37, True, False, True)
                End Select
            ...
            Case eMessages.HaveKilledUser
                ...
                Level = IIf(Val(frmMain.lblLvl) - Level > 5, "¡" & Level & "!", Level)
                Call ShowConsoleMsg(MENSAJE_HAS_MATADO_A & charlist(CharIndex).Nombre & "(" & Level & ")", 255, 37, 37, True, False)
            ...
            Case eMessages.UserKill
                Call ShowConsoleMsg(charlist(.ReadInteger).Nombre & MENSAJE_TE_HA_MATADO, 255, 37, 37, True, False)
                If ClientSetup.bDie And ClientSetup.bActive Then _
                   isCapturePending = True
            Case eMessages.EarnExp
                Call ShowConsoleMsg(MENSAJE_HAS_GANADO_EXPE_1 & .ReadLong & MENSAJE_HAS_GANADO_EXPE_2, 255, 37, 37, True, False)
            Case eMessages.GoHome
                Call ShowConsoleMsg("Estas concentrandote para teletransportarte a tu hogar", 255, 37, 37, True)
                Call ShowConsoleMsg("No podes cancelar este comando", 255, 37, 37, True)
                'Elimino por completo el tiempo al hogar.
                Dim Distance As Byte
                'Despues arreglar error raro de obtencion de dato de busqueda ASCII
                Dim Hogar As String
                Dim Tiempo As Integer
                Distance = .ReadByte
                Tiempo = .ReadInteger
                Hogar = .ReadASCIIString
                Call ShowConsoleMsg("Estás a " & Distance & " mapas de distancia de " & Hogar & ", este viaje durará " & Tiempo & " segundos.", 255, 37, 37, True)
                Traveling = True
            Case eMessages.FinishHome
                Call ShowConsoleMsg(MENSAJE_HOGAR, 255, 255, 255)
                Traveling = False
            Case eMessages.CancelGoHome
                Call ShowConsoleMsg(MENSAJE_HOGAR_CANCEL, 255, 37, 37, True)
                Traveling = False
        End Select
    End With
End Sub
...
Private Sub HandleLogged()
    ...
    INT_CAST_SPELL = incomingData.ReadInteger
    INT_ATTACK = incomingData.ReadInteger
    INT_CAST_ATTACK = incomingData.ReadInteger

    INT_WORK = incomingData.ReadInteger
    INT_USEITEMU = incomingData.ReadInteger
    INT_USEITEMDCK = incomingData.ReadInteger
    INT_ARROWS = incomingData.ReadInteger
...
Private Sub HandleUpdateSta()
    ...
    frmMain.shpEnergia.Left = 574 + (89 - frmMain.shpEnergia.Width)
...
Private Sub HandleUpdateMana()
    ...
    frmMain.shpMana.Left = 574 + (89 - frmMain.shpMana.Width)
...
Private Sub HandleUpdateHP()
    ...
    frmMain.shpVida.Left = 574 + (89 - frmMain.shpVida.Width)
...
Private Sub HandleUpdateExp()
    ...
    If Not UserExp = 0 And Not UserPasarNivel = 0 Then
        ...
        frmMain.ExpShp.Width = Round(((UserExp / 100) / (UserPasarNivel / 100)) * 161)
    Else
        frmMain.ExpShp.Visible = True
    End If
End Sub
...
Private Sub HandleChangeMap()
    ...
    MapInfo.Name = incomingData.ReadASCIIString()
    MapInfo.EsDungeon = incomingData.ReadByte()

    If FileExist(DirMapas & "Mapa" & UserMap & ".map", vbNormal) Then
        Call SwitchMap(UserMap)
        
        ColourName = 255
        FadingTime = 600 'Tiempo Nombre Mapa

        If MapInfo.EsDungeon Then
...
Private Sub HandlePosUpdate()
    ...
    frmMain.imgChar.Top = UserPos.Y
    frmMain.imgChar.Left = UserPos.X
End Sub
...
Private Sub HandleNPCHitUser()
    '***************************************************
    'Author: Juan Martín Sotuyo Dodero (Maraxus)jj
    'Last Modification: 05/17/06
    '
    '***************************************************
...
Private Sub HandleUserHittedByUser()
    ...
    Select Case incomingData.ReadByte
        Case bCabeza
            Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_1 & attacker & MENSAJE_RECIVE_IMPACTO_CABEZA & CStr(incomingData.ReadInteger() & MENSAJE_2), 255, 37, 37, True, False, True)
        Case bBrazoIzquierdo
            Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_1 & attacker & MENSAJE_RECIVE_IMPACTO_BRAZO_IZQ & CStr(incomingData.ReadInteger() & MENSAJE_2), 255, 37, 37, True, False, True)
        Case bBrazoDerecho
            Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_1 & attacker & MENSAJE_RECIVE_IMPACTO_BRAZO_DER & CStr(incomingData.ReadInteger() & MENSAJE_2), 255, 37, 37, True, False, True)
        Case bPiernaIzquierda
            Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_1 & attacker & MENSAJE_RECIVE_IMPACTO_PIERNA_IZQ & CStr(incomingData.ReadInteger() & MENSAJE_2), 255, 37, 37, True, False, True)
        Case bPiernaDerecha
            Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_1 & attacker & MENSAJE_RECIVE_IMPACTO_PIERNA_DER & CStr(incomingData.ReadInteger() & MENSAJE_2), 255, 37, 37, True, False, True)
        Case bTorso
            Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_1 & attacker & MENSAJE_RECIVE_IMPACTO_TORSO & CStr(incomingData.ReadInteger() & MENSAJE_2), 255, 37, 37, True, False, True)
    End Select
End Sub
...
Private Sub HandleUserHittedUser()
    ...
    Select Case incomingData.ReadByte
        Case bCabeza
            Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_PRODUCE_IMPACTO_1 & Victim & MENSAJE_PRODUCE_IMPACTO_CABEZA & CStr(incomingData.ReadInteger() & MENSAJE_2), 255, 37, 37, True, False, True)
        Case bBrazoIzquierdo
            Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_PRODUCE_IMPACTO_1 & Victim & MENSAJE_PRODUCE_IMPACTO_BRAZO_IZQ & CStr(incomingData.ReadInteger() & MENSAJE_2), 255, 37, 37, True, False, True)
        Case bBrazoDerecho
            Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_PRODUCE_IMPACTO_1 & Victim & MENSAJE_PRODUCE_IMPACTO_BRAZO_DER & CStr(incomingData.ReadInteger() & MENSAJE_2), 255, 37, 37, True, False, True)
        Case bPiernaIzquierda
            Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_PRODUCE_IMPACTO_1 & Victim & MENSAJE_PRODUCE_IMPACTO_PIERNA_IZQ & CStr(incomingData.ReadInteger() & MENSAJE_2), 255, 37, 37, True, False, True)
        Case bPiernaDerecha
            Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_PRODUCE_IMPACTO_1 & Victim & MENSAJE_PRODUCE_IMPACTO_PIERNA_DER & CStr(incomingData.ReadInteger() & MENSAJE_2), 255, 37, 37, True, False, True)
        Case bTorso
            Call AddtoRichTextBox(frmMain.RecTxt, MENSAJE_PRODUCE_IMPACTO_1 & Victim & MENSAJE_PRODUCE_IMPACTO_TORSO & CStr(incomingData.ReadInteger() & MENSAJE_2), 255, 37, 37, True, False, True)
    End Select
End Sub
...
Private Sub HandleErrorMessage()
    ...
    If InStr(1, Mensaje, "La contraseña fue c") > 0 Then
        AccountPassword = AccountNewPassword
    End If
...
Private Sub HandleUpdateHungerAndThirst()
    ...
    frmMain.shpHambre.Left = 574 + (89 - frmMain.shpHambre.Width)
    ...
    frmMain.shpSed.Left = 574 + (89 - frmMain.shpSed.Width)
...
Private Sub HandlePong()
    ...
    Call AddtoRichTextBox(frmMain.RecTxt, "El ping es " & (GetTickCount - pingTime) & " ms.", 255, 37, 37, True, False, True)
...
Public Sub WriteLoginNewChar()
    ...
    With outgoingData
        ...
        Call .WriteASCIIString(UserCaptcha)
    End With
...
Public Sub WriteUseItem(ByVal Slot As Byte, ByVal ByClick As Byte)
    '***************************************************
    'Author: Juan Martín Sotuyo Dodero (Maraxus)
    'Last Modification: 05/17/06
    'Writes the "UseItem" message to the outgoing data buffer
...
Public Sub WriteReset()
    'derveT
    Call outgoingData.WriteByte(ClientPacketID.Reset)
End Sub
...
Public Sub WriteCuentaRegresiva(ByVal Cuenta As Integer, ByVal Map As Integer)
'***************************************************
...
'***************************************************
    ...
    With outgoingData
        Call .WriteByte(ClientPacketID.GMCommands)
        Call .WriteByte(eGMCommands.CuentaRegresiva)
...
Private Sub HandleShowFormViajes()
    ...
    MAX_CIUDADES = Buffer.ReadByte()
    ReDim Viajes(1 To MAX_CIUDADES) As tViajes
    ...
    For LoopC = 1 To MAX_CIUDADES
        With Viajes(LoopC)
            .ID = Buffer.ReadByte()
            .Nombre = Buffer.ReadASCIIString()
            .Nombre = .Nombre & " - Zona " & IIf(Buffer.ReadByte() > 0, "segura", "insegura")
            .Precio = Buffer.ReadLong()
            .Tiempo = Buffer.ReadInteger()
...
''
' Writes the "Viajar" message to the outgoing data buffer.
'
' @remarks  The data is not actually sent until the buffer is properly flushed.

Public Sub WriteViajar(ByVal Index As Byte)
    '***************************************************
...
Public Sub WriteLoginNewAccount()
    ...
    With outgoingData
        ...
        Call .WriteASCIIString(AccountPin)
        Call .WriteByte(App.Major)
        Call .WriteByte(App.Minor)
        Call .WriteByte(App.Revision)
    End With
...
Private Sub HandleAccountLogged()
    ...
    If NumberOfCharacters <> 0 Then
        Dim LoopC As Long, priv As Byte

        For LoopC = 1 To 8
            If LoopC <= NumberOfCharacters Then
                With cPJ(LoopC)
                    .Nombre = Buffer.ReadASCIIString()
                    .Body = Buffer.ReadInteger()
                    .Head = Buffer.ReadInteger()
                    ...
                    If priv <> 0 And priv <> 255 Then
                        'If the player belongs to a council AND is an admin, only whos as an admin
                        If (priv And PlayerType.ChaosCouncil) <> 0 And (priv And PlayerType.User) = 0 Then
                            priv = priv Xor PlayerType.ChaosCouncil
                        End If

                        If (priv And PlayerType.RoyalCouncil) <> 0 And (priv And PlayerType.User) = 0 Then
                            priv = priv Xor PlayerType.RoyalCouncil
                        End If

                        'If the player is a RM, ignore other flags
                        If priv And PlayerType.RoleMaster Then
                            priv = PlayerType.RoleMaster
                        End If

                        'Log2 of the bit flags sent by the server gives our numbers ^^
                        .Estatus = Log(priv) / Log(2)
                    Else
                        .Estatus = priv
                    End If
                    ...
                    Select Case .Estatus
                        Case 0
                            'CIUDA
                            frmPanelAccount.lblAccData(LoopC).ForeColor = 16744448
                        Case 255
                            'CRIMI
                            frmPanelAccount.lblAccData(LoopC).ForeColor = 255
                        Case Else
                            'GMs
                            frmPanelAccount.lblAccData(LoopC).ForeColor = RGB(ColoresPJ(.Estatus).r, ColoresPJ(.Estatus).g, ColoresPJ(.Estatus).b)
                    End Select

                    frmPanelAccount.lblAccData(LoopC).Caption = .Nombre

                End With
                
                Call frmPanelAccount.DrawPJ(LoopC)

            Else
                frmPanelAccount.picChar(LoopC - 1).Cls
...
Public Sub WriteRecoverAccount()
    ...
    With outgoingData
        ...
        Call .WriteByte(ClientPacketID.RecoverAccount)
        Call .WriteASCIIString(AccountName)
        Call .WriteASCIIString(AccountEmail)
        Call .WriteASCIIString(AccountPin)
...
Public Sub WriteChangePasswordAccount()

    With outgoingData

        Call .WriteByte(ClientPacketID.ChangePasswordAccount)
        Call .WriteASCIIString(AccountPassword)
...
Public Sub WriteDeleteCharAccount()

    With outgoingData

        Call .WriteByte(ClientPacketID.DeleteCharAccount)
        Call .WriteByte(Seleccionado)
        Call .WriteASCIIString(AccountEmail)
        Call .WriteASCIIString(AccountPin)
...
Public Sub WriteSendCaptions()
    ...
    Call outgoingData.WriteASCIIString(frmCaptions.Listar)
    Call outgoingData.WriteByte(frmCaptions.CANTv)
    frmCaptions.CANTv = 0
End Sub
...
Private Sub HandleShowCaptions()
    ...
    Dim data() As String
    data = Split(Buffer.ReadASCIIString(), "#")
    ...
    For LoopC = 0 To UBound(data())
        frmCaptions.List1.AddItem data(LoopC)
    Next LoopC

    frmCaptions.Show
    frmCaptions.Label1.Caption = "Captions de " & frmPanelGm.cboListaUsus.Text
...
Public Sub WriteOtherSendReto(ByRef Oponnent As String, ByVal Gold As Long, ByVal Drop As Byte, ByVal Points As Long)

    With outgoingData

        Call .WriteByte(ClientPacketID.OtherSendReto)
        Call .WriteASCIIString(Oponnent)
        Call .WriteLong(Gold)
        Call .WriteByte(Drop)
        Call .WriteLong(Points)

    End With

End Sub

Public Sub WriteSendReto(ByVal MyTeam As String, ByVal Enemy As String, ByVal TeamEnemy As String, ByVal Drop As Boolean, ByVal Gold As Long, ByVal Points As Long, ByVal Respawn As Boolean)

    With outgoingData

        Call .WriteByte(ClientPacketID.SendReto)
        Call .WriteASCIIString(MyTeam)
        Call .WriteASCIIString(Enemy)
        Call .WriteASCIIString(TeamEnemy)
        Call .WriteBoolean(Drop)
        Call .WriteLong(Gold)
        Call .WriteLong(Points)
        Call .WriteBoolean(Respawn)
...
Public Sub WriteAcceptReto(ByVal SendName As String)
    ...
    With outgoingData
        ...
        Call .WriteASCIIString(SendName)

    End With

End Sub

Private Sub HandleUpdateSegHP()
    ...
    Dim tMinHP As Integer
    tMinHP = incomingData.ReadInteger()

    If tMinHP < 0 Then tMinHP = 0
    frmPanelSeg.lblVida = tMinHP & "/" & tMaxHP

    If tMaxHP > 0 Then
        frmPanelSeg.ImgVida.Width = ((tMinHP / 100) / (tMaxHP / 100)) * 1725
    End If

End Sub

Private Sub HandleUpdateSegMANA()
    ...
    Dim tMinMAN As Integer
    tMinMAN = incomingData.ReadInteger()

    If tMinMAN < 0 Then tMinMAN = 0
    frmPanelSeg.lblMana = tMinMAN & "/" & tMaxMAN

    If tMinMAN > 0 Then
        frmPanelSeg.ImgMana.Width = ((tMinMAN / 100) / (tMaxMAN / 100)) * 1725
    End If

End Sub

Private Sub HandleUpdateSegInitial()
    ...
    Dim tMinHP As Integer, tMinMAN As Integer
...
Public Sub WriteSeguimiento(ByVal UserName As String)

    With outgoingData
        Call .WriteByte(ClientPacketID.GMCommands)
        Call .WriteByte(eGMCommands.Seguimiento)
        Call .WriteASCIIString(UserName)
    End With

    If UserName <> "1" Then
        frmPanelSeg.Caption = "Seguimiento a: " & UserName
    End If

End Sub

Public Sub WriteSolicitarRanking(ByVal Tipo As Byte)
...
Private Sub HandleRecibirRanking()
    ...
    For i = 0 To 8
        If LenB(Ranking.Nombre(i)) > 0 Then
            frmRanking.lblNombre(i + 1).Caption = Ranking.Nombre(i)
            frmRanking.lblValor(i + 1).Caption = Ranking.Value(i)
        Else
            frmRanking.lblNombre(i + 1).Caption = "VACANTE"
            frmRanking.lblValor(i + 1).Caption = "N/A"
        End If
    Next i
...
Private Sub HandleCuentaRegresiva()
    ...
    CountTime = Buffer.ReadInteger()
    If CountTime > 0 Then CountFinish = 0
...
Public Sub HandleCaptchaCode()
    ...
    Captcha(0) = incomingData.ReadByte()
    Captcha(1) = incomingData.ReadByte()
    Captcha(2) = incomingData.ReadByte()
    Captcha(3) = incomingData.ReadByte()
    
    Call frmCrearPersonaje.UpdateCaptcha
