...
Begin VB.Form frmComerciarUsu 
   ...
   Begin VB.Image imgCancelar 
      Height          =   360
      Left            =   525
      MouseIcon       =   "frmComerciarUsu.frx":007D
   ...
   Begin VB.Image imgRechazar 
      Height          =   360
      Left            =   8265
      MouseIcon       =   "frmComerciarUsu.frx":01CF
      MousePointer    =   99  'Custom
      Tag             =   "2"
      Top             =   8160
      Width           =   1095
   ...
   Begin VB.Image imgConfirmar 
      Height          =   360
      Left            =   7560
      MouseIcon       =   "frmComerciarUsu.frx":0321
      MousePointer    =   99  'Custom
      Tag             =   "2"
      Top             =   4080
      Width           =   1260
   ...
   Begin VB.Image imgAceptar 
      Height          =   360
      Left            =   7050
      MouseIcon       =   "frmComerciarUsu.frx":0473
      MousePointer    =   99  'Custom
      Tag             =   "2"
      Top             =   8160
      Width           =   1095
   ...
   Begin VB.Image imgAgregar 
      Height          =   240
      Left            =   4875
      MouseIcon       =   "frmComerciarUsu.frx":05C5
      MousePointer    =   99  'Custom
      Top             =   1920
      Width           =   270
   End
   Begin VB.Image imgQuitar 
      Height          =   255
      Left            =   4875
      MouseIcon       =   "frmComerciarUsu.frx":0717
      MousePointer    =   99  'Custom
      Top             =   2745
      Width           =   270
   End
