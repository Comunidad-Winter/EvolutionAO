...
Public Sub ActStats(ByVal VictimIndex As Integer, ByVal AttackerIndex As Integer)
    ...
    With UserList(AttackerIndex)
        ...
        'Call WriteMultiMessage(AttackerIndex, eMessages.HaveKilledUser, VictimIndex, UserList(VictimIndex).Stats.ELV)
...
Public Sub ToogleBoatBody(ByVal UserIndex As Integer)
    ...
    With UserList(UserIndex)
        ...
        If .Invent.BarcoObjIndex < 1 Then Exit Sub
...
Public Sub CheckUserLevel(ByVal UserIndex As Integer)
    ...
    With UserList(UserIndex)
        Do While .Stats.Exp >= .Stats.ELU
            ...
            If .Stats.ELV = 1 And .Stats.SkillPts > 10 Then
                Pts = 10
            Else
            ...
            Select Case .clase
                ...
                Case eClass.Mage
                    AumentoHIT = 1
                    If .raza = Enano Then
                        AumentoMANA = 2.5 * .Stats.UserAtributos(eAtributos.Inteligencia)
                    Else
...
PasoNivel:
        ...
        If Not EsNewbie(UserIndex) And WasNewbie Then
            ...
            If UCase$(MapInfo(.Pos.map).Restringir) = "NEWBIE" Then
                Call WarpUserChar(UserIndex, 104, 56, 39, True)
...
Sub MoveUserChar(ByVal UserIndex As Integer, ByVal nHeading As eHeading)
    ...
    If MoveToLegalPos(UserList(UserIndex).Pos.map, nPos.X, nPos.Y, sailing, Not sailing) Then
        ...
        If Not ((UserList(UserIndex).flags.AdminInvisible = 1) And CasperIndex <> 0) Then
            ...
            If HayCura(UserIndex) Then
                Call AutoResurreccion(UserIndex)
            End If
...
Sub AutoResurreccion(ByVal UserIndex As Integer)
    ...
    If UserList(UserIndex).flags.Muerto = 1 Then
        ...
        UserList(UserIndex).Stats.MinSta = UserList(UserIndex).Stats.MaxSta    'Resucita con max Stamina.
        Call WriteUpdateSta(UserIndex)
        Call SendData(SendTarget.ToPCArea, UserIndex, PrepareMessageCreateFX(UserList(UserIndex).Char.CharIndex, FXRESUCITAR, 0)) 'FX RESUCITAR
...
#End If
        ...
        Call WriteConsoleMsg(sendIndex, "Retos Ganados: " & .Stats.RetosGanados & " - Retos Perdidos: " & .Stats.RetosPerdidos, FontTypeNames.FONTTYPE_INFO)
    End With
End Sub
...
Sub SubirSkill(ByVal UserIndex As Integer, ByVal Skill As Integer, ByVal Acerto As Boolean)
    ...
    With UserList(UserIndex)
        With .Stats
            ...
            Call WriteConsoleMsg(UserIndex, "¡Has ganado 10 puntos de experiencia!", FontTypeNames.FONTTYPE_FIGHT)
...
Sub UserDie(ByVal UserIndex As Integer)
    ...
    With UserList(UserIndex)
        ...
        If (.sReto.Reto_Index <> 0) Then
            If (m_Retos2vs2.Reto_List(.sReto.Reto_Index).Used_Ring) Then
                Call m_Retos2vs2.User_Die_Reto(UserIndex)
            End If
        End If
        ...
        'Que sucede si muere en ronda un usuuario del torneo...
...
Sub WarpUserChar(ByVal UserIndex As Integer, ByVal map As Integer, ByVal X As Integer, ByVal Y As Integer, ByVal FX As Boolean, Optional ByVal Teletransported As Boolean)
    ...
    With UserList(UserIndex)
        ...
        If OldMap <> map Then
            Call WriteChangeMap(UserIndex, map, MapInfo(map).Llueve)
...
Public Sub goHome(ByVal UserIndex As Integer)
    ...
    With UserList(UserIndex)
        If .flags.Muerto = 1 Then
            ...
            Call WriteConsoleMsg(UserIndex, "En 1 segundo te teletransportaras a la ciudad.", FontTypeNames.FONTTYPE_FIGHT)
        Else
