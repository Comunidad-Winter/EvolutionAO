...
'@@ Copa del sistema de retos
Public Const COPA_OBJ As Integer = 710

'@@ Requisitos para fundar clan
Public Const COPA_OBJ_CLAN As Integer = 406    'CAMBIAR
Public Const COPA_AMOUNT As Byte = 10    'CAMBIAR

Public CantMaps As Integer
Public MapBackup() As Integer

Public Const MAX_COSTAS As Byte = 48
Public Array_Costas_Agua(1 To MAX_COSTAS) As Integer

Public Const INTERVALO_GLOBAL As Byte = 10    'Segundos
...
Public Const FXAPUÑALAR As Byte = 58    'Cambiar por el numero de FX
Public Const FXRESUCITAR As Byte = 42    'Cambiar por el numero de FX
Public Const FXGOLPE As Byte = 14  'Cambiar por el numero de FX
...
Public Const MAX_ORO_EDIT As Long = 99999999
...
Public Const FONTTYPE_FIGHT As String = "~255~37~37~1~0"
...
Public Type UserFlags
    automatico As Boolean 'Utilizado para torneos
...
Public Type User
    LastTickCaptcha As Long
    CaptchaCode(3) As Byte
    
    ElPedidorSeguimiento As Integer
    Siguiendo As Integer

    UltimoGlobal As Long    ' @@ Anti Flodeo Global

    Account As String
    PasswordLogged As String

    PosViaje As WorldPos
...
Public NumUsersLevelOne As Integer
...
Public Enum eGMCommands
    ...
    Seguimiento             'Seguimiento de vida/mana desde /panelgm
