...
Begin VB.Form frmMain 
   ...
   Begin VB.Timer tAutoGP 
      Interval        =   60000
      Left            =   2400
      Top             =   600
   End
   Begin VB.Timer TimerTorneo 
      Interval        =   60000
      Left            =   2400
      Top             =   120
   End
...
Private Sub AutoSave_Timer()
    ...
    Static Current          As Integer 'Para mensajes personalizados
    ...
    Call m_HappyHour.PasarMinutoHappy
            ...
            If .Activado = 1 Then
                    If Current >= .Tiempo Then
                            ...
                            For LoopC = 1 To UBound(.Mensajes())
                                    Call SendData(SendTarget.ToAll, 0, PrepareMessageConsoleMsg("Anuncio> " & .Mensajes(LoopC), FontTypeNames.FONTTYPE_INFOBOLD))
...
' variable estática para acumular la cantidad de segundos
    ...
    ' comprueba que los segundos sea igual a los minutos
    If Temp_Seg = INTERVALO_AUTO_GP Then
       ' iniciamos y reestablece
        ...
        With UserList(i)
            If .flags.UserLogged Then
                If MapData(.Pos.map, .Pos.X, .Pos.Y).trigger = eTrigger.ANTIPIQUETE Then
                    ...
                    If .Counters.PiqueteC > 18 Then 'Esto estaba 23, vamos acortar el tiempo para mandar carcel.
                        .Counters.PiqueteC = 0
                ...
                If .flags.Muerto = 1 Then
                    If .flags.Traveling = 1 Then
                        If .Counters.goHome <= 0 Then
                            ...
                            Call WarpUserChar(i, 104, 56, 39, True)
...
Private Sub TimerTorneo_Timer()
    ...
    '    Case 84
    '    Call SendData(SendTarget.ToAll, 0, PrepareMessageConsoleMsg("Torneo Automático> En 10 minutos se realizará un torneo automático.", FontTypeNames.FONTTYPE_SERVER)) 'Hecho por tomih :B
    '    Case 89
    '    Call SendData(SendTarget.ToAll, 0, PrepareMessageConsoleMsg("Torneo Automático> En 5 minutos se realizará un torneo automático.", FontTypeNames.FONTTYPE_SERVER))
    '    Case 93
    '    Call SendData(SendTarget.ToAll, 0, PrepareMessageConsoleMsg("Torneo Automático> En 1 minuto se realizará un torneo automático.", FontTypeNames.FONTTYPE_SERVER))
    '    Case 94
    '    Call torneos_auto(RandomNumber(3, 4)) ' con esto se hace un random si el torneo sera de 8 a 16 participantes.
    '    Case 96
